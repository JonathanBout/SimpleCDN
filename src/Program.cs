...
#pragma warning disable RCS1102 // This class can't be static because the integration tests want it as a type argument
	internal class Program
	{
		private static void Main(string[] args)
		{
			...
			app.MapGet(GlobalConstants.SystemFilesRootedPath + "/server/health", () => "healthy");

			app.MapGet("/favicon.ico", () => Results.Redirect(GlobalConstants.SystemFilesRootedPath + "/logo.ico", true));
