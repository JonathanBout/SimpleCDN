...
{
	public class EndpointTests : IClassFixture<CustomWebApplicationFactoryWrapper>
	{
		private readonly CustomWebApplicationFactoryWrapper _webApplicationFactory;

		const string TEXT_FILE_NAME = "test.txt";

		const string JSON_FILE_NAME = "data/test.json";

		public EndpointTests(CustomWebApplicationFactoryWrapper webApplicationFactory)
		{
